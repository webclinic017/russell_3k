...
class The_Only_Mailer(object):
    ...
    def mail_em_out(self):
        ...
        if exists(
            f"/home/gdp/russell_3k/reports/port_results/{self.saveMonth}/{self.today_stamp}/maximum_sharpe_ratio.csv"
        ):
            try:
                attachments_lst = [
                    f"/home/gdp/russell_3k/reports/port_results/{self.saveMonth}/{self.today_stamp}/maximum_sharpe_ratio.csv",
                    f"/home/gdp/russell_3k/reports/port_results/{self.saveMonth}/{self.today_stamp}/maximum_sharpe_equalWT.csv",
                    # f"/home/gdp/russell_3k/reports/port_results/{self.saveMonth}/{self.today_stamp}/markowitz_random.csv",
                    f"/home/gdp/russell_3k/reports/port_results/{self.saveMonth}/{self.today_stamp}/minimum_volatility_portfolio.csv",
                    f"/home/gdp/russell_3k/reports/port_results/{self.saveMonth}/{self.today_stamp}/monte_carlo_cholesky.csv",
                ]
            except:
                pass
